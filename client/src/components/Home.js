...
const Home = () => {
  return (
    <div className='Home'>
      ...
      <p>
        The Sparks Foundation bank Corporation is an Indian multinational investment bank and
        financial services holding company headquartered in Bangaluru. Sparks Foundation bank
      ...
      <p>
        ...
        presence in 17 countries. Sparks Foundation Bank is one of the Big banks of India. The
